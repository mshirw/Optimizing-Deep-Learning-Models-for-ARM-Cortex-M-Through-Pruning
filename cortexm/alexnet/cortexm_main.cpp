...
#define CONV0_CHANNEL 16
#define CONV1_CHANNEL 32
#define CONV2_CHANNEL 32
#define CONV3_CHANNEL 64
...
static q7_t conv0_wt[CONV0_CHANNEL*3*3*3] = CONV0_WEIGHT;
static q7_t conv0_bias[CONV0_CHANNEL] = CONV0_BIAS;

static q7_t conv1_wt[CONV1_CHANNEL*CONV0_CHANNEL*3*3] = CONV1_WEIGHT;
static q7_t conv1_bias[CONV1_CHANNEL] = CONV1_BIAS;

static q7_t conv2_wt[CONV2_CHANNEL*CONV1_CHANNEL*3*3] = CONV2_WEIGHT;
static q7_t conv2_bias[CONV2_CHANNEL] = CONV2_BIAS;

static q7_t conv3_wt[CONV3_CHANNEL*CONV2_CHANNEL*3*3] = CONV3_WEIGHT;
static q7_t conv3_bias[CONV3_CHANNEL] = CONV3_BIAS;
