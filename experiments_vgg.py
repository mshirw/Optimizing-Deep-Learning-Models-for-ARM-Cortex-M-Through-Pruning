...
def Asymmetric_activate(data):
    out = Asymmetric_quantization(data, 8, True)
    out = out.to(device)
    return out
...
file = "./saves/vgg_experiments/pruned_model_best_"
...
for convlayer in range(len(conv_list)):
    for percent in range(len(percent_list)):
        ...
        filename = "./saves/vgg_experiments/cortexm_weight_"
